...
to init-person [ age-gender-dist ] ; person command
  ...
  set max-education-level pick-from-pair-list table:get edu male?
  ...
  ask persons with [ not male? and age >= 14 and age <= 50 ] [
    if random-float 1 < p-fertility [
      ...
      hatch-persons 1 [
        ...
        set max-education-level [ max-education-level ] of one-of in-offspring-link-neighbors with [ male? ]
      ]
    ]
  ]
end
