...
PATH_PYTHON = "E:\\proton\\candidate_we\\res"
...
plt.plot(superrun_python["baseline"].current_oc_members, label="python")
plt.plot(superrun_netlogo["baseline"].o1, label="netlogo")
plt.legend()
plt.show()
